...
<section id="main" class="page">
    <header class="page-header">
        <div class="container">
            <h3>효모 데이터베이스 - <span class="semi-bold">YEAST DATABASE</span></h3>
        </div>
    </header>
    <div class="container">
        <div class="row">
            <article class="content col-sm-12 col-md-12">
                <div class="bs-docs-section">
                    <form class="form-no-horizontal-spacing" id="searchForm"  name="searchForm" modelAttribute="paramYeast">
                        <input name="type" type ="hidden" id="type" type="text"  class="form-control" value="">
                        <div>
                            <h5>이름으로 찾기</h5>
                            <div class="input-group col-sm-6">
                                <input name="name" id="name" type="text"  class="form-control" placeholder="효모 이름" onkeypress="javascript:if(event.keyCode == 13){search();}">
