...
<div class="container-fluid paper-wrap bevel tlbr">
            ...
            <div class="dark" style="visibility: visible;">
                <form class="navbar-form navbar-left" role="search">
                    <div class="form-group">
                        <input type="text" class="form-control search rounded id_search"
                               placeholder="Search">
                    </div>
                </form>
            </div>
    ...
    <div id="footer">
        ...
        <div class="copyright">Copyright &copy; 2014 <a
                href="http://ndesaintheme.com/">Themesmile</a> Made with <i
...
<script type='text/javascript'
        src='/resources/brewing/js/scriptbreaker-multiple-accordion-1.js'></script>
<script type='text/javascript' src='/resources/brewing/js/tip/jquery.tooltipster.min.js'></script>
<script type='text/javascript'
        src="/resources/brewing/js/donut-chart/jquery.drawDoughnutChart.js"></script>
...
<script src="/resources/brewing/js/datatables/dataTables.bootstrap.js"
        type="text/javascript"></script>

<script src="/resources/brewing/js/footable/js/footable.js?v=2-0-1" type="text/javascript"></script>
<script src="/resources/brewing/js/footable/js/footable.sort.js?v=2-0-1"
        type="text/javascript"></script>
<script src="/resources/brewing/js/footable/js/footable.filter.js?v=2-0-1"
        type="text/javascript"></script>
<script src="/resources/brewing/js/footable/js/footable.paginate.js?v=2-0-1"
        type="text/javascript"></script>
<script src="/resources/brewing/js/footable/js/footable.paginate.js?v=2-0-1"
        type="text/javascript"></script>
