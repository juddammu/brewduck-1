...
<section id="main" class="page">
    ...
    <div class="container">
        <script type="text/javascript" src="/resources/asset/smarteditor/js/HuskyEZCreator.js"
                charset="utf-8"></script>
        <div class="row">
            <div class="content search-result list col-sm-12 col-md-12">
                <form:form id="board" name="board" method="POST" action="/board/writeBoardArticle"
                           modelAttribute="board">
                    <div class="row frame border-radius">
                        <div class="col-md-12">
                            <div class="row">
                                <div class="bottom-padding-mini"></div>
                                <input name="bbsType" id="bbsType" type="hidden"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <input id="nttSj" name="nttSj" type="text" class="form-control"
                                           value="">
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <textarea id="nttCn" name="nttCn" placeholder="내용 입력..."
                                              class="form-control" rows="10"
                                              style="width:auto; height:400px;"></textarea>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-3">
                            ...
                            <div class="row">
                                <div class="col-md-12 form-actions">
                                    <div class="pull-right">
                                        <button type="button" id="create" class="btn btn-danger"
                                                onclick="fn_egov_regist_notice()"><i
                                                class="icon-ok"></i> 등록
                                        </button>
                                        <button type="button" id="list" class="btn btn-primary">
                                            목록
                                        </button>
                                    </div>
                                </div>
