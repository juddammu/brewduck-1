...
<jsp:useBean id="boardController" class="com.brewduck.web.common.controller.BoardController"
             scope="session"/>
<%
        ...
        <ul class="latest-posts">
            <li class="text-left text">
                <img class="image img-circle"
                     src="http://template.progressive.itembridge.com/2.1.8/img/content/product-1.png"
                     alt="" title="" width="84" height="84" data-appear-animation="rotateIn">
