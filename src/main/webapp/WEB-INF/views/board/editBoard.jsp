...
<div id="tm-page-title">
    <div class="tm-wrap tm-table">
        <div class="tm-title-captions">
            <a href="/board/editBoard/${EditBoard.nttId}"><h2 class="tm-entry-title">게시물 수정 <span
                    class=""><i class="fa fa-edit"></i></span></h2></a>
        </div>
...
<form:form id="board" name="board" method="POST" enctype="multipart/form-data"
           action="/board/updateBoardArticle" modelAttribute="board">
...
<div>
    <input type="text" name="nttSj" id="nttSj" class="form-control" style="width: 100%;"
           placeholder="제목" value="${EditBoard.nttSj}">
</div>
<div>
<p>
