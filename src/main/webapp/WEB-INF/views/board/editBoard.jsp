...
<div id="tm-page-title">
    <div class="tm-wrap tm-table">
        <div class="tm-title-captions">
            <a href="/board/editBoard/${EditBoard.nttId}"><h2 class="tm-entry-title">게시물 수정     <span class=""><i class="fa fa-edit"></i></span></h2></a>
        </div>
        <ul class="tm-breadcrumbs">
            ...
            <li>
                <a href="/board/main/${EditBoard.bbsId}">${EditBoard.bbsNm}</a>
            </li>
            <li>
                <a href="/board/editBoard/${EditBoard.nttId}">게시물 수정</a>
            </li>
        </ul>
    </div>
</div>
<div id="tm-page-body">
    <div id="tm-single-blog" class="tm-container tm-wrap">
            ...
            <div class="page-content-inner">
                ...
                <div class="entry-container">
                    <div class="entry-content">
                            <form:form id="board" name="board" method="POST" enctype="multipart/form-data" action="/board/updateBoardArticle" modelAttribute="board">
                            ...
                            <div>
                                <input type="text" name="nttSj" id="nttSj" class="form-control" style="width: 100%;" placeholder="제목" value="${EditBoard.nttSj}">
                            </div>
                            <div>
                            <p>
                                <div>
                            ...
                            <div class="pull-right">
                                <button type="button" onclick='updateContent();' class="tm-btn green">등록</button>
                                <button type="button" id = "delete"class="tm-btn red"> 삭제 </button>
                                <button type="button" id = "list" class="tm-btn blue"> 목록 </button>
                            </div>
                            <br>
                            </form:form>
                    </div>
...
<content tag="local_script">
    ...
    <script type="text/javascript">
        ...
        function deleteContent(bbsId,nttId){
            //TODO : 클릭시, COMMAND VALUE 값 DELETE VALUE로 세팅
            alert("게시물을 삭제 하겠습니까?");

            location.href = "/board/deleteBoardArticle/"+bbsId+"/"+nttId;
        ...
        function loadContent() {
            ...
            attachments['image'].push({
                'attacher': 'image',
                'data': {
                    'imageurl': '/resources/upload/${noticeView.filename}',
                    'filename': '${noticeView.filename}',
                    'filesize': '${noticeView.filesize}',
                    'originalurl': '/resources/upload/${noticeView.filename}',
                    'thumburl': '/resources/upload/${noticeView.filename}'
                }
            });
            </c:if>
            attachments['file'] = [];
        ...
        $("#list").click(function(){
            goList(${EditBoard.bbsId});
        });

        $("#delete").click(function(){
            deleteContent(${EditBoard.bbsId},${EditBoard.nttId});
        });
