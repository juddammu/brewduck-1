...
<div id="tm-page-title">
    <div class="tm-wrap tm-table">
        <div class="tm-title-captions">
            <a href="/board/detail/${BoardDetail.nttId}"><h2
                    class="tm-entry-title">${BoardDetail.nttSj}</h2></a>
        </div>
        ...
        <div class="page-content">
            <div class="page-content-inner">
                ...
                <div class="entry-header">
                    ...
                    <div class="time">
                        <h6><span
                                class="meta">${BoardDetail.insertDate}  |  읽음 : ${BoardDetail.rdcnt} </span>
                        </h6>
                    </div>
                </div>
                <!--entry-header-->
                <div class="entry-container">
                    ...
                    <section class="about-author">
                        <h3 class="tm-title">작성자 :
                            <a href="/list/recipe/${BoardDetail.boardId}/${BoardDetail.insertId}">${BoardDetail.insertId}</a>
                            님
                        </h3>
                    ...
                    <div class="form-group">
                        <div class="col-md-12 form-actions">
                            <div class="pull-right">
                                ...
                                %>
                                <button type="button" id="edit" class="tm-btn red"
                                        style="width: 90px;"> 수정
                                </button>
                                ...
                                %>
                                <button type="button" id="list" class="tm-btn blue"
                                        style="width: 90px;"> 목록
                                </button>
                            </div>
                        </div>
                    ...
                    <section id="respond">
                        <form:form id="commentform" onsubmit="return false">
                            ...
                            <p>
                                <button type="submit" id="insertReply" name="insertReply"
                                        class="tm-btn">댓글 등록
                                </button>
                            </p>
                            <%
        ...
        <div class="page-sidebar">
            <aside class="widget tm-tabs">
                ...
                <div class="tab-container">
                    <aside id="tab1"
                           class="widget tm-list-style2 widget_recent_entries tab-content">
                        <ul>
                            <c:forEach items="${newRecipeList}" var="newRecipeList"
                                       varStatus="status">
                                <li>
                                    <a href="/public/recipe/${newRecipeList.brewer}/${newRecipeList.seq}/${newRecipeList.titleInUrl}">
                        <span class="thumb">
                        <img src="/resources/upload/${newRecipeList.atchCoverFileName}" width="60"
                             alt="thumb">
                        </span>
                    ...
                    <aside id="tab2"
                           class="widget tm-list-style2 widget_recent_comments tab-content">
