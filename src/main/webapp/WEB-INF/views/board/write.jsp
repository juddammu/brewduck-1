            ...
            <div class="page-content-inner">
                ...
                <div class="entry-container">
                    <div class="entry-content">
                            <form:form id="notice" class="form-horizontal" role="form" method="POST" enctype="multipart/form-data"  action="/board/writeArticle" modelAttribute="board">
                            ...
                            <div>
                                <input type="text" name="nttSj" id="nttSj" class="form-control" style="width: 100%;" placeholder="제목" value="${noticeView.title}">
                            </div>
                            <div>
                                <p>
                                    <div>
