...
<div id="tm-page-title">
    <div class="tm-wrap tm-table">
        <div class="tm-title-captions">
            <a href="#" onclick="refresh()"><h2 class="tm-entry-title">게시물 작성 <span class=""><i
                    class="fa fa-book"></i></span></h2></a>
        </div>
...
<form:form id="notice" class="form-horizontal" role="form" method="POST"
           enctype="multipart/form-data" action="/board/writeArticle" modelAttribute="board">
<input type="hidden" name="bbsId" id="bbsId" value="${writeBoard.bbsId}"/>
...
<div>
    <input type="text" name="nttSj" id="nttSj" class="form-control" style="width: 100%;"
           placeholder="제목" value="${noticeView.title}">
</div>
<div>
<p>
...
<div class="pull-right">
    <button type="button" onclick='saveContent();' class="tm-btn green">등록</button>
    <button type="button" onclick='loadContent();' class="tm-btn red">Reset</button>
