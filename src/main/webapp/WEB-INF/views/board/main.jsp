            ...
            <div class="col-md-12">
                ...
                <div class="portlet light">
                    <div class="portlet-title">
                        <form:form class="form-horizontal" action="/board/" id="boardSerchForm"
                                   name="boardSerchForm" modelAttribute="paramBoard">
                            <input name="bbsId" id="bbsId" type="hidden" class="form-control"
                                   value="${boardList.bbsId}">
                            ...
                            <div class="form-group">
                                <div class="col-sm-11">
                                    ...
                                    <input type="text" id="name" name="name" class="form-control"
                                           placeholder="검색어를 입력하세요." value="${paramBoard.name}">
                    ...
                    <div class="tm-row tm-right">
                        <form:form method="post" action="/board/write">
                            ...
                            %>
                            <button class="btn btn-white btn-single" id="write" name="write">게시물
                                작성
                            </button>
                            <%
                                }
