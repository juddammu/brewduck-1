            ...
            <div class="col-md-12">
                ...
                <div class="portlet light">
                    <div class="portlet-title">
                        <form:form class="form-horizontal" action="/style/" id="searchForm"
                                   name="searchForm" modelAttribute="paramStyle">
                            ...
                            <table cellspacing="0"
                                ...
                                <c:forEach items="${list}" var="list">
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/style/${list.id}/${list.titleInUrl}">${list.koreanName}</a>
                                        </td>
                                        <td> ${list.name}</td>
                                        <td>
