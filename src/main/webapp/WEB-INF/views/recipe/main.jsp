...
<section>
    ...
    <div class="section-header">
        <h3 class="text-standard"><i
                class="fa fa-fw fa-arrow-circle-right text-gray-light"></i>${recipeMain.category}
            스타일 레시피</h3>
    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="box box-outlined">
                    <div class="box-body">
                        <form:form class="form-horizontal" id="searchForm" name="searchForm"
                                   modelAttribute="recipe">
                            <input name="styleCategory" id="styleCategory" type="hidden"
                                   class="form-control" value="${recipeMain.categoryNumber}">
                            <input name="brewer" id="brewer" type="hidden" class="form-control"
                                   value="${recipeMain.brewer}">

                            <div class="form-group">
                                <input name="sort" id="sort" type="hidden" class="form-control"
                                       value="">

                                <div class="col-md-2">
                                    <select class="form-control select2-active" name="select2"
                                            id="select2">
