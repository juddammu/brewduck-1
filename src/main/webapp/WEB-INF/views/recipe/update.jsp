...
<form:form id="insert" name="insert" method="POST" enctype="multipart/form-data"
           action="/recipe/insertRecipe" modelAttribute="paramRecipe">
    <div class="container">
        <div class="form-group">
            <div class="controls">
                ...
                <input type="file" name="file" id="fileInput"
                       value="${paramRecipe.coverImageFile}"/>
                <button class="btn btn-default" type="submit" id="insertRecipe" name="insertRecipe">
                    저장
                </button>
            </div>
        </div>
    ...
    <div class="step-title">
        <div class="number">
            <button type="button" class="btn btn-primary btn-sm" data-toggle="modal"
                    data-target="#FermentableModal">추가
            </button>
        </div>
                        ...
                        <tr style="height: 50px;">
                            <td>
                                <div class="form-group" id="the-basics">
                                    <input type="email" style="width:280px"
                                           class="typeahead form-control" id="exampleInputEmail1"
                                           placeholder="2-Row (US)">
                                </div>
                            </td>
                            <td>
                                <div class="form-group alignright">
                                    <input type="text" class="form-control border-error"
                                           style="width:45px">
                                </div>
                            </td>
                            <td>
                            ...
                            <td>
                                <div class="form-group">
                                    <input type="email" style="width:70px" class="form-control"
                                           id="exampleInputEmail1" placeholder="25%">
                                </div>
                            </td>
                            <td>
                                <select class="form-control border-error">
                                    <option value="">모름</option>
                                    <option value="9">Bairds</option>
                                    <option value="14">Boortmalt</option>
                                    <option value="1">Briess</option>
                                    <option value="5">Castle</option>
                                    <option value="8">Crisp</option>
                                    <option value="15">Dingemans</option>
                                    <option value="13">Edwin Ticker &amp; Sons</option>
                                    <option value="11">Gambrinus</option>
                                    <option value="6">GlobalMalt</option>
                                    <option value="10">Great Western</option>
                                    <option value="12">Muntons</option>
                                    <option value="7">Rahr</option>
                                    <option value="4">Simpson's</option>
                                    <option value="2">Thomas Fawcett &amp; Sons</option>
                                    <option value="3">Weyermann®</option>
                                </select>
                            </td>
                            <td>
                                <select class="form-control border-error">
                                    ...
                                    <option value="4">Late Boil</option>
                                    <option value="1">Mash</option>
                                    <option value="2">Steep</option>
                                </select>
                            </td>
                            <td>
                                <div class="form-group">
...
<li class="panel">
    <a href="#step-2" class="collapsed step-title" data-parent="#checkoutsteps"
...
<li class="panel">
    <a href="#step-3" class="collapsed step-title" data-parent="#checkoutsteps"
       data-toggle="collapse">
...
<li class="panel">
    <a href="#step-4" class="collapsed step-title" data-parent="#checkoutsteps"
       data-toggle="collapse">
...
<li class="panel">
    <a href="#step-5" class="collapsed step-title" data-parent="#checkoutsteps"
       data-toggle="collapse">
    ...
    <div id="step-5" class="collapse">
        <div class="step-content">
            <form>
                <div>
                    <label class="radio"><input type="radio" name="register"> Checkout as
                        Guest</label>
...
<li class="panel">
    <a href="#step-6" class="collapsed step-title" data-parent="#checkoutsteps"
       data-toggle="collapse">
    ...
    <aside class="widget">
        ...
        <a href="portfolio-single.html" class="work">
            ...
            <div class="work-title">
                ...
                <div class="description">이 맥주는 시트러한 아로마로 시작해 Earth한 피니시로 마무리되며, 밝은 적갈색에 25IBU로 여름에
                    세션비어로 디자인되어 있다.
                </div>
            </div>
        </a>
...
<!-- Modal 팝업 -->
<div class="modal auto-width fade" id="FermentableModal" tabindex="-1" role="dialog"
                    ...
                    <c:forEach items="${fermentableList}" var="list">
                        <tr>
                            <td>
                                <div class="checkbox">
                                    <label>
                                        <input id="fermatable_id" class="form-control"
                                               type="checkbox" value="${list.seq}">
                                    </label>
                                </div>
                            </td>
                            <td>${list.name}</td>
