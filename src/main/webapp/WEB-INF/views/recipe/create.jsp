...
<div class="form-group">
    ...
    <div class="col-md-10">
        <input type="text" class="form-control" id="name" name="name"
               placeholder="레시피 이름을 입력하세요. 예를들면 '유자 페일에일'" required>
    </div>
</div>
<div class="form-group">
    <div class="col-md-2">
...
<div class="box-head">
    ...
    목표 스펙 -
    <small id="ogSpec" name="ogSpec"><span class='tag label label-info'>OG  </span> 1.028 ~ 1.04
    </small>
    <small id="fgSpec" name="fgSpec"><span class='tag label label-info'>FG  </span> 0.998 ~ 1.008
    </small>
    <small id="srmSpec" name="srmSpec"><span class='tag label label-info'>SRM  </span> 2 ~ 3</small>
    <small id="ibuSpec" name="ibuSpec"><span class='tag label label-info'>IBU  </span> 8 ~ 12
    </small>
    <small id="advSpec" name="advSpec"><span class='tag label label-info'>ADV  </span> 2.8 ~ 4.2
    </small>
</div>
<div class="form-group">
    <div class="col-md-2">
