...
<div class="page-head">
    <div class="container-fluid">
        ...
        <div class="page-title">
            <h1>알콜 함유량 계산기
                <small>ABV(Alcohol By Volume) Calculator</small>
            </h1>
        </div>
        <!-- END PAGE TITLE -->
    </div>
                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-body form">
                            ...
                            <form class="form-horizontal" role="form">
                                <div class="form-body">
                                    <h4 class="form-section">장비에 눈금을 맞춰놓고 온도를 조절해야 한다는 것을
                                        기억하세요.</h4>
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input id="og" name="og" type="text"
                                                       class="form-control" placeholder="예를들면 1.05">
                                            </div>
                                        </div>
                                        <!--/span-->
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input id="fg" name="fg" type="text"
                                                       class="form-control" placeholder="예를들면 1.01">
                                            </div>
                                        </div>
                                        <!--/span-->
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input id="oBrix" name="oBrix" type="text"
                                                       class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            <label class="control-label col-md-3">Measured Final
                                                Brix
                                                <small>Final Gravity</small>
                                            </label>

                                            <div class="col-md-9">
                                                <input id="mBrix" name="mBrix" type="text"
                                                       class="form-control">
                                                ...
                                                <small>알코올은 측정된 굴절률에 영향을 미치므로 당도 측정기를 이용하여 발효 후의
                                                    브릭스를 다시 재야합니다.
                                                </small>
                                                <br/>
                                                <small>Brix값은 당용굴절계를 사용하여 자당의 중량 백분율에 상당하는 굴절률로부터
                                                    당도를 측정합니다.
                                                </small>
                                            </div>
                                        </div>
