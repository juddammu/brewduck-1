...
<section>
    <ol class="breadcrumb">
        <li><a href="#">홈</a></li>
        <li><a href="#">계산기</a></li>
        <li class="active">Mash Water
            <small> Calculator</small>
        </li>
    </ol>
    <div class="section-header">
        <h3 class="text-standard"><i class="fa fa-fw fa-arrow-circle-right text-gray-light"></i>당화용
            물 <strong class="text-support3">계산기</strong></h3>
    </div>
                    ...
                    <div class="box-body no-padding">
                        <form class="form-horizontal form-banded form-bordered"
                            ...
                            <div class="form-group">
                                <div class="col-md-2">
                                    <label class="control-label">시간
                                        <small>Time</small>
                                    </label>
                                </div>
                                <div class="col-md-10">
                                    <input id="mash-time" name="mash-time" type="text" value="60"
                                           class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-md-2">
                                    <label class="control-label">온도
                                        <small>Temperature</small>
                                    </label>
                                </div>
                                <div class="col-md-10">
                                    <input id="saccharification-temp" name="saccharification-temp"
                                           type="text" class="form-control" value="68">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-md-2">
                                    <label class="control-label">곡물 무게
                                        <small>Grain weight</small>
                                    </label>
                                </div>
                                <div class="col-md-10">
                                    <input id="grain-weight" name="grain-weight" type="text"
                                           class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-md-2">
                                    <label class="control-label">Boil volume
                                        <small>Boil volume</small>
                                    </label>
                                </div>
                                <div class="col-md-10">
                                    <input id="boil-volume" name="boil-volume" type="text"
                                           class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-md-2">
                                    <label class="control-label">Lauter deadspace
                                        <small>Lauter deadspace</small>
                                    </label>
                                </div>
                                <div class="col-md-10">
                                    <input id="lauter-deadspace" name="lauter-deadspace" type="text"
                                           class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-md-2">
                                    <label class="control-label">Mash thickness
                                        <small>Mash thickness</small>
                                    </label>
                                </div>
                                <div class="col-md-10">
                                    <input id="mash-thickness" name="mash-thickness" type="text"
                                           class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-md-2">
                                    <label class="control-label">Boiling temperature
                                        <small>Boiling temperature</small>
                                    </label>
                                </div>
                                <div class="col-md-10">
                                    <input id="boiling-temp" name="boiling-temp" type="text"
                                           class="form-control" value="100"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-md-3">
                                    <label class="control-label">Grain absorption factor
                                        <small>Grain absorption factor</small>
                                    </label>
                                </div>
                                <div class="col-md-9">
                                    <input id="grain-absorption-factor"
                                           name="grain-absorption-factor" type="text"
                                           class="form-control">
                                </div>
                            </div>
                            <div class="form-footer col-md-offset-2 col-sm-offset-3">
                                <select id="equipment-profile" class="small"
                                        disabled=&quot;disabled&quot;>
                                    <option id="55422" data-grain-absorption-factor="0.1"
                                            data-boiling-temp="100.0" data-mash-thickness="1.2"
                                            data-lauter-deadspace="1.89">Default
                                    </option>
                                </select>
                                <select id="mash-profile">
                                    <option value="1">Single Infusion, Batch Sparge</option>
                                    <option value="2">Single Infusion, Mash Out, Batch Sparge
                                    </option>
                                    <option value="3">Single Infusion, Mash Out, Batch Sparge (Equal
                                        Runnings)
                                    </option>
                                    <option value="4">Single Infusion, Two Equal Batch Sparges
                                    </option>
