...
<section>
    <ol class="breadcrumb">
        <li><a href="#">홈</a></li>
        <li><a href="#">계산기</a></li>
        <li class="active">Pitch Rate
            <small> Calculator</small>
        </li>
    </ol>
    <div class="section-header">
        <h3 class="text-standard"><i class="fa fa-fw fa-arrow-circle-right text-gray-light"></i>Pitch
            Rate <strong class="text-support3">계산기</strong></h3>
    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="box box-outlined">
                    <div class="box-head">
                        <header><h4 class="text-light"><i class="fa fa-pencil fa-fw"></i>맥주를 발효할때,
                            얼마만큼의 <strong>효모</strong>세포가 필요한지 계산합니다.</h4></header>
                    </div>
                    <div class="box-body no-padding">
                        <form class="form-horizontal form-banded form-bordered"
                            ...
                            <div class="form-group">
                                <div class="col-md-2">
                                    <label class="control-label">Measurement system
