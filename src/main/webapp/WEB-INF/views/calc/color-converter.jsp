...
<section>
    ...
    <div class="section-header">
        <h3 class="text-standard"><i class="fa fa-fw fa-arrow-circle-right text-gray-light"></i>색상
            <strong class="text-support3">변환기</strong></h3>
    </div>
            ...
            <div class="col-lg-12">
                <div class="box box-outlined">
                    <div class="box-head">
                        ...
                        <header><h4 class="text-light"><i class="fa fa-pencil fa-fw"></i>세 곳 중 한곳에
                            수치를 입력하면 나머지 두 곳은 <strong>자동</strong>으로 계산됩니다</h4></header>
                    ...
                    <div class="box-body no-padding">
                        <form class="form-horizontal form-banded form-bordered"
                            ...
                            <div class="form-group">
                                <div class="col-md-2">
                                    <label class="control-label">° L
                                        <small>lovibond</small>
                                    </label>
                                </div>
                                <div class="col-md-10">
                            ...
                            <div class="form-footer col-md-offset-2 col-sm-offset-3">
                                ...
                                이 툴은 양조 시 색을 측정할 때 가장 많이 사용되는 세가지 방식인 SRM, EBC, Lovibond 간의 변환을 쉽게 할
                                수 있도록 해줍니다. EBC와 SRM을 측정하는 과정은 매우 유사하며 EBC 수치가 SRM의 약 두 배라고 볼 수
                                있습니다. EBC와 SRM은 일반적으로 맥아즙의 색을 측정할 때 쓰이며 로비본드는 훨씬 오래된 방식으로 몰트의 색을 측정할
                                때 가장 많이 쓰입니다.
                            </div>
                        </form>
                    </div>
