        ...
        <ul id="menu-showhide" class="topnav">
            ...
            <li>
                <a class="tooltip-tip" href="/hop/" title="Dashboard">
                    ...
                    <span><spring:message code="menu.hop"/><small class="side-menu-noft bg-aqua">
                        HOT
                    </small></span>
            ...
            <li>
                <a class="tooltip-tip" href="/homebrew/myrecipes" title="Icons">
                    ...
                    <div class="noft-blue bg-green" style="display: inline-block; float: none;">
                        New
                    </div>
                </a>
            </li>
            ...
            <li>
                ...
                <ul>
                    <li>
                        <a href="/calc/abv-calculator" title="Invoice"><spring:message
                                code="menu.alcohol.calculators"/></a>
                    </li>
                    <li>
                        <a href="/calc/color-converter" title="Pricing Table"><spring:message
                                code="menu.color.converter"/></a>
                    </li>
                </ul>
            </li>
            ...
            <ul class="side-dashh-list">
                <li>
                    ...
                    <a href="#">
                        ...
                        <div class="progress xs bg-opacity-one height-tiny">
                            <div class="progress-bar bg-blue " style="width: 35%" role="progressbar"
                ...
                <li>
                    ...
                    <a href="#">
                        ...
                        <div class="progress xs bg-opacity-one height-tiny">
                            <div class="progress-bar bg-aqua" style="width: 40%" role="progressbar"
                                 aria-valuenow="20" aria-valuemin="0" aria-valuemax="100">
                ...
                <li>
                    ...
                    <a href="#">
                        ...
                        <div class="progress xs bg-opacity-one height-tiny">
                            <div class="progress-bar bg-red-orange" style="width: 60%"
