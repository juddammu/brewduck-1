...
<img src="<c:url value='/download/downloadFile.do?'/>requestedFile=${recipeDetail.atchCoverFileName}"
     hidden="hidden"/>
...
<div class="entry-header">
    ...
    <div class="meta">
        <a href="/list/recipe/${recipeDetail.brewer}/${recipeDetail.brewerNm}">${recipeDetail.brewerNm}</a>
        님
...
<div class="tm-row">
    ...
    <h2 class="tm-title">홉 -
        <small>hops ${recipeDetail.boilTime} 분</small>
    </h2>
    <table class="tm-table tm-style1">
        <thead>
        <tr class="header">
...
<section id="respond">
    <form:form id="commentform" class="form-horizontal" role="form" onsubmit="return false">
        <p class="comment-form-comment">
            ...
            %>
            <a href="/account/login"><textarea id="answer" name="answer">로그인 후 등록할 수
                있습니다.</textarea></a>
            <%
            } else {
            %>
        ...
        <p class="form-submit">
            <input id="insertReply" name="insertReply" class="tm-btn" type="submit"
                   value="Post Comment">
        </p>
    </form:form>
</section>
