...
<section id="main_data" >
    ...
    <div class="section-body">
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <div data-toggle="buttons">
                    <label class="btn radio-inline btn-radio-primary-inverse active" onclick="setStatus(0)">
                        <input type="radio" id="hidden" name="type" value="0" checked> 비공개 - Private Recipe
                    </label>
                    <label class="btn radio-inline btn-radio-primary-inverse"onclick="setStatus(2)" >
                        <input type="radio" id="open" name="type" value="2"> 공개 - Publish Recipe
                    </label>
                </div>
            </div>
        </div>
        ...
        <div id="thurmnailImage" class="form-group">
            <div class="col-md-2">
                <label class="control-label">썸네일<small>작은 사이즈</small></label>
            </div>
            <div class="col-md-10">
