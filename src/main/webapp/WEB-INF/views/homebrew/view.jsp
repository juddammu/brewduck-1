...
<div class="box-header">
    ...
    <h3 class="box-title fontello-doc">
...
<div class="row no-print">
    <div class="col-xs-12">
        ...
        <button class="btn pull-right btn-warning" style="margin-right: 5px;" id="clipboard-btn"
                href="javascript:;"><i class="fa fa-copy"></i> 복사
        </button>
    </div>
</div>
<!-- title row -->
