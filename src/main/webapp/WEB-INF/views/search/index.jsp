                                    ...
                                    <article>
                                        <div class="tm-content-inner">
                                            <div class="entry-thumbnail">
                                                <a href="#">
                                                    <img width="150"
                                                         src="<c:url value='/download/downloadFile.do?'/>requestedFile=${recipeList.atchCoverFileName}"
                                                         alt="Thumb">
                                                </a>
                                            </div>
                                            <div class="entry-container">
                                                ...
                                                <div class="meta">
                                                    by
                                                    <a href="#"
                                                       class="author">${recipeList.brewerNm}</a>
                                                    in
                ...
                <ul class="product_list_widget">
                    <li>
                        <a title="Product" href="">
                            <img alt="img" width="70" height="70"
                                 src="http://placehold.it/70x70/eee">
                            Fathom
                        </a>
