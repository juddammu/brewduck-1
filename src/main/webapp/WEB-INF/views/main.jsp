...
<content tag="local_script">
    <link rel="stylesheet" href="/resources/brewing/css/dashboard.css">
    <script type='text/javascript' src="/resources/brewing/js/number-progress-bar/jquery.velocity.min.js"></script>
    <script type='text/javascript' src="/resources/brewing/js/number-progress-bar/number-pb.js"></script>
    <script src="/resources/brewing/js/loader/loader.js" type="text/javascript"></script>
    <script src="/resources/brewing/js/loader/demo.js" type="text/javascript"></script>
    <script type="text/javascript" src="/resources/brewing/js/skycons/skycons.js"></script>
