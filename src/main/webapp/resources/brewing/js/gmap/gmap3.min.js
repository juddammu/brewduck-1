...
!function (t, n) {
    ...
    function B(n, e, i) {
        ...
        o(i) && (i = a(i)), l.run = function () {
            for (var o, a; o = r();) {
                if (z(n[o]))return s = o, a = t.extend(!0, {}, A[o] || {}, i[o].options || {}), void(o in d.latLng ? i[o].values ? L(i[o].values, n, n[o], {td: i[o], opts: a, session: u}) : w(n, n[o], d.latLng[o], {td: i[o], opts: a, session: u}) : o in d.geoloc ? b(n, n[o], {td: i[o], opts: a, session: u}) : n[o].apply(n, [
    ...
    function U(i) {
        ...
        x._plan = function (t) {
            ...
            return a || (n.td.values = [
                {latLng: n.latLng, options: n.opts}
