...
(function (e, t, n, r) {
    function s(n, s) {
        ...
        function l() {
            ...
            e(".collapse", u).each(function () {
                "#" + this.id === a ? e(this).hasClass("in") ? e(this).collapse({parent: c, toggle: !1}) : e(this).collapse({parent: c, toggle: !0}) : e(this).hasClass("in") ? e(this).collapse({parent: c, toggle: !0}) : e(this).collapse({parent: c, toggle: !1})
            });
            f(a);
            ...
            if (s.addButtons) {
                e("." + s.stepClass, u).children("button[type='" + s.nextType + "']").click(function (t) {
                    t.preventDefault();
                    var n = e(this).parents(".accordion-body")[0], r = "#" + e(".accordion-body", e(n).parents(".accordion-group").next(".accordion-group")[0])[0].id;
                    e(r).collapse("show");
                    p("onNext", n)
                });
                e("." + s.stepClass, u).children("button[type='" + s.backType + "']").click(function (t) {
                    t.preventDefault();
                    var n = e(this).parents(".accordion-body")[0], r = "#" + e(".accordion-body", e(n).parents(".accordion-group").prev(".accordion-group")[0])[0].id;
                    e(r).collapse("show");
                    p("onPrev", n)
                })
            }
        ...
        l();
        return{option: c, destroy: h}
    }

    var i = "accwizard";
    e.fn[i] = function (t) {
        if (typeof arguments[0] == "string") {
            var n = arguments[0], o = Array.prototype.slice.call(arguments, 1), u;
            this.each(function () {
    ...
    e.fn[i].defaults = {addButtons: !0, sidebar: ".acc-wizard-sidebar", activeClass: "acc-wizard-active", completedClass: "acc-wizard-completed", todoClass: "acc-wizard-todo", stepClass: "acc-wizard-step", nextText: "Next Step", backText: "Go Back", nextType: "submit", backType: "reset", nextClasses: "btn btn-primary", backClasses: "btn", onNext: function () {
    }, onBack: function () {
    }, onInit: function () {
    }, onDestroy: function () {
    }}
