...
var Zepto = function () {
    ...
    var f, g, c, u, w = [], B = w.slice, D = w.filter, v = window.document, I = {}, H = {}, J = v.defaultView.getComputedStyle, M = {"column-count": 1, columns: 1, "font-weight": 1, "line-height": 1, opacity: 1, "z-index": 1, zoom: 1}, N = /^\s*<(\w+|!)[^>]*>/,
        T = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/ig, O = /^(?:body|html)$/i, U = "val css html text data width height offset".split(" "), K = v.createElement("table"), P = v.createElement("tr"), Q = {tr: v.createElement("tbody"), tbody: K, thead: K, tfoot: K, td: P, th: P, "*": v.createElement("div")}, V = /complete|loaded|interactive/, W = /^\.([\w-]+)$/, X = /^#([\w-]*)$/, Y = /^[\w-]+$/, G = {}, S = G.toString, n = {}, L, F, R = v.createElement("div");
    ...
    c.fn = {forEach: w.forEach, reduce: w.reduce, push: w.push, sort: w.sort, indexOf: w.indexOf, concat: w.concat, map: function (a) {
...
(function (h) {
    ...
    var y = function () {
        ...
        return!1
    }, z = /^([A-Z]|layer[XY]$)/, E = {preventDefault: "isDefaultPrevented",
        ...
        return this.each(function (c, j) {
            k(j, f, g, e, function (c) {
                return function (f) {
                    ...
                    if (k)return g = h.extend(l(f), {currentTarget: k, liveFired: j}), c.apply(k, [g].concat([].slice.call(arguments, 1)))
                }
            })
        })
    };
