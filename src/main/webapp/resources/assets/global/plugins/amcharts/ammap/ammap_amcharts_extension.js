AmCharts.AmMap = AmCharts.Class({inherits: AmCharts.AmChart, construct: function (a) {
    ...
    var g = b.customData;
    void 0 == g && (g = "");
    return a = AmCharts.massReplace(a, {"[[title]]": e, "[[value]]": f,
...
AmCharts.SmallMap = AmCharts.Class({construct: function (a) {
    ...
    minimize: function () {
        ...
        var a = this.chart, b = {fill: this.mapColor, stroke: this.mapColor, "stroke-opacity": 1}, c = a.svgData.g.path, d = this.container, e = d.set(), f;
    ...
    for (q = 0; q < b.length; q++) {
        ...
        if (p.remainVisible || c.selectedObject == p.parentObject) {
            ...
            if (0 < A.length) {
                ...
                p.fixedSize && N && (this.linesToResize.push({line: N, thickness: v}), this.linesToResize.push({line: I, thickness: 3}));
                p.lineSvg = N;
