AmCharts.AmStockChart = AmCharts.Class({construct: function (a) {
    ...
    d.chartRendered ||
    (f = "rendered", d.fire(f, {type: f, chart: d}), d.chartRendered = !0);
    f = "drawn";
                ...
                if (h.comparable) {
                    ...
                    for (B = 0; B < x; B++) {
                        ...
                        if (g) {
                            ...
                            this.comparedGraphs.push({graph: q, dataSet: A})
                        }
                    }
                }
...
AmCharts.DataSetSelector = AmCharts.Class({construct: function (a) {
    ...
    for (d = 0; d < c.length; d++)e =
        c[d], e.compared && (a = {type: "dataSetUncompared", dataSet: e}), e.compared = !1;
    c = b.selectedIndex;
