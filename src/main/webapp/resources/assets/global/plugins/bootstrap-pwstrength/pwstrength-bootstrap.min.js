    ...
    !function (a, c) {
        ...
        d = function (c) {
            ...
            void 0 !== j && (j.instances.errors = [], j.common.zxcvbn ? (d = [], a.each(j.common.userInputs, function (b, c) {
                d.push(a(c).val())
            }), d.push(a(j.common.usernameField).val()), h = zxcvbn(k, d).entropy) : h = b.executeRules(j, k), f.updateUI(j, i, h), e = f.getVerdictAndCssClass(j, h), g = e[2], e = e[0], j.common.debug && console.log(h + " - " + e), a.isFunction(j.common.onKeyUp) && j.common.onKeyUp(c, {score: h, verdictText: e, verdictLevel: g}))
        }, c.init = function (b) {
