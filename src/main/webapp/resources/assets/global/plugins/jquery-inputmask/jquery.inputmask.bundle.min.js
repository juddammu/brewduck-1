...
!function (a) {
    ...
    function f(d, e, f) {
        ...
        function v(b, c, d) {
            ...
            return(0 == j.length || k) && j.push({match: {fn: null, cardinality: 0, optionality: !0, casing: null, def: ""}, locator: []}), n().tests[b] = a.extend(!0, [], j), n().tests[b]
        }
        ...
        function A(b, c, d, e) {
            function g(b, c, d, e) {
                ...
                return a.each(v(b), function (h, i) {
                    ...
                    if (c && (l += c), g = null != j.fn ? j.fn.test(l, n(), b, d, f) : c != j.def && c != f.skipOptionalPartCharacter || "" == j.def ? !1 : {c: j.def, pos: b}, g !== !1) {
        ...
        function M(b, c, d) {
            ...
            if ("number" != typeof c) {
                ...
                return!a(g).is(":visible") && h && void 0 != h.caret ? (c = h.caret.begin, d = h.caret.end) : g.setSelectionRange ? (c = g.selectionStart, d = g.selectionEnd) : document.selection && document.selection.createRange && (e = document.selection.createRange(), c = 0 - e.duplicate().moveStart("character", -1e5), d = c + e.text.length), c = L(c), d = L(d), {begin: c, end: d}
            }
            c = L(c), d = L(d), d = "number" == typeof d ? d : c;
            var h = a(g).data("_inputmask") || {};
            h.caret = {begin: c, end: d}, a(g).data("_inputmask", h), a(g).is(":visible") && (g.scrollLeft = g.scrollWidth, 0 == f.insertMode && c == d && d++, g.setSelectionRange ? (g.selectionStart = c, g.selectionEnd = d) : g.createTextRange && (e = g.createTextRange(), e.collapse(!0), e.moveEnd("character", d), e.moveStart("character", c), e.select()))
        }
        ...
        function ab(b) {
            if (cb = a(b), cb.is(":input") && c(cb.attr("type"))) {
                if (cb.data("_inputmask", {maskset: e, opts: f, isRTL: !1}), f.showTooltip && cb.prop("title", n().mask), ("rtl" == b.dir || f.rightAlign) && cb.css("text-align", "right"), "rtl" == b.dir || f.numericInput) {
                ...
                cb.unbind(".inputmask"), cb.closest("form").bind("submit",function () {
                    ...
                    U(c, g, {begin: n().p, end: n().p}), c._valueGet() == w().join("") && d.trigger("cleared"), f.showTooltip && d.prop("title", n().mask)
        ...
        if (void 0 != d)switch (d.action) {
            ...
            case"mask":
                ...
                break;
            case"format":
                cb = a({}), cb.data("_inputmask", {maskset: e, opts: f, isRTL: f.numericInput}), f.numericInput && (eb = !0);
                var jb = (a.isFunction(f.onBeforeMask) ? f.onBeforeMask.call(cb, d.value, f) || d.value : d.value).split("");
                return I(cb, !1, !1, eb ? jb.reverse() : jb), f.onKeyPress.call(this, void 0, x(), 0, f), d.metadata ? {value: eb ? x().slice().reverse().join("") : x().join(""), metadata: cb.inputmask("getmetadata")} : eb ? x().slice().reverse().join("") : x().join("");
            case"isValid":
                cb = a({}), cb.data("_inputmask", {maskset: e, opts: f, isRTL: f.numericInput}), f.numericInput && (eb = !0);
    ...
    return a.extend(a.inputmask.defaults.aliases, {numeric: {mask: function (a) {
        ...
        if (!d && (e.allowMinus && "-" === a || e.allowPlus && "+" === a)) {
            ...
            if (f && f[f.index].length > 0 && ("0" !== f[f.index] || b.buffer && b._buffer && b.buffer.join("") != b._buffer.join("")))return b.buffer[f.index] == ("-" === a ? "+" : "-") ? {pos: f.index, c: a, remove: f.index, caret: c} : b.buffer[f.index] == ("-" === a ? "-" : "+") ? {remove: f.index, caret: c - 1} : {pos: f.index, c: a, caret: c + 1}
        }
        return!1
    ...
    }}, currency: {prefix: "$ ", groupSeparator: ",", alias: "numeric", placeholder: "0", autoGroup: !0, digits: 2, digitsOptional: !1, clearMaskOnLostFocus: !1}, decimal: {alias: "numeric"}, integer: {alias: "numeric", digits: "0", radixPoint: ""}}), a.fn.inputmask
}(jQuery), function (a) {
    return a.extend(a.inputmask.defaults.aliases, {phone: {url: "phone-codes/phone-codes.js", maskInit: "+pp(pp)pppppppp", countrycode: "", mask: function (b) {
    ...
    }, nojumps: !0, nojumpsThreshold: 1, onBeforeMask: function (a, b) {
        var c = a.replace(/^0/g, "");
        return(c.indexOf(b.countrycode) > 1 || -1 == c.indexOf(b.countrycode)) && (c = b.countrycode + c), c
    }}, phonebe: {alias: "phone", url: "phone-codes/phone-be.js", countrycode: "32", nojumpsThreshold: 4}}), a.fn.inputmask
}(jQuery), function (a) {
